...
```{r}
table<-game24table(5,24)
head(table)
```

#4) game24prob
 This function helps user to get information on the probability of combinations of a card that is being able to get 24. The probability was calculated from game24table.
```{r}
game24prob(7,24)
game24prob(4,24)
```
